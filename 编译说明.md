...
```shell
curl -X POST -d "params=1;2" http://127.0.0.1:8081/etl/es7/customer.yml 
```
...
```shell
curl http://127.0.0.1:8081/count/es7/customer.yml
```

`手动ETL`

```shell
curl -X POST -d "params=2018-10-21 00:00:00" http://127.0.0.1:8081/etl/es7/customer.yml 
```
