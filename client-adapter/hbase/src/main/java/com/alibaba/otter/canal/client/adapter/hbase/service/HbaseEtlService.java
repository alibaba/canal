...
public class HbaseEtlService extends AbstractEtlService {
    ...
    public EtlResult importData(List<String> params) {
        ...
        try {
            ...
            String tableFullName = hbaseMapping.getDatabase() + "." + hbaseMapping.getTable();
            // 拼接sql
            String sql = "SELECT * FROM " + tableFullName;
            return super.importData(sql, params, tableFullName, hbaseMapping.getSequenceColumn());
        } catch (Exception e) {
            logger.error(e.getMessage(), e);
                                ...
                                if (columnItem.getType() == null || "".equals(columnItem.getType())) {
                                    ...
                                    if (MappingConfig.Mode.STRING == hbaseMapping.getMode()) {
                                        ...
                                        if (columnItem.isRowKey()) {
                                            ...
                                            row.addCell(columnItem.getFamily(), columnItem.getQualifier(),
