...
public class SocketChannel {
    ...
    // 参考 mysql-connector-java-5.1.40.jar: com.mysql.jdbc.MysqlIO.maxThreeBytes < 256 * 256 * 256 = 16MB
                    ...
                    if (cache.readerIndex() >= deltaSize) { // 可以清理
                        ...
                        if (oldCapacity < maxDirectBuffer) {
                            ...
                            try {
                                ...
                                // failed to allocate 885571168 byte(s) of direct memory (used: 1002946176, max: 1888485376)
